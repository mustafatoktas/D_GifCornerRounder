...
- Your feedback is highly valuable! For suggestions, questions or discussions use the
  [discussions page](https://github.com/mustafatoktas/D_GifCornerRounder/discussions).
  To report issues or bugs, visit the
  [issues page](https://github.com/mustafatoktas/D_GifCornerRounder/issues).
...
Before contributing, check the [existing issues](https://github.com/mustafatoktas/D_GifCornerRounder/issues) and
[open pull requests](https://github.com/mustafatoktas/D_GifCornerRounder/pulls). Someone might already be working on a similar topic.
